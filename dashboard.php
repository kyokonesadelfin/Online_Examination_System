  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dashboard.php?q=2">User Rankings</a></li>
    <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dashboard.php?q=3">Feedback</a></li>
    <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="dashboard.php?q=4">Add Exams</a></li>
...
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$year.'</td><td>'.$section.'</td><td>'.$email.'</td><td>'.$mobile.'</td>
